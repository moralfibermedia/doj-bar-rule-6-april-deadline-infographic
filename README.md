...
🔗 **[View the live infographic →](https://doj-bar-rule-6-april-deadline-infographic.netlify.app)**  
...
This project is released for public use. Share it, adapt it, embed it. Attribution to Moral Fiber Media appreciated but not required. The civic record matters more than the credit.
